  ...
  const columns: ProColumns<Order>[] = [
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        if (record.status === 'shipped' && canCompleteOrder) {
          actions.push(
            <Popconfirm
              key="complete"
              title="确认完成订单?"
