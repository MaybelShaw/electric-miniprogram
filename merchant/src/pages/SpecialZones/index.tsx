...
import { getSpecialZones, createSpecialZone, updateSpecialZone, deleteSpecialZone, uploadImage } from '@/services/api';
import type { ActionType, ProColumns } from '@ant-design/pro-components';
import type { SpecialZone } from '@/services/types';
      ...
      <ModalForm
        ...
        onFinish={async (values) => {
          ...
          try {
            ...
            if (editingRecord) {
              await updateSpecialZone(editingRecord.id, data);
              message.success('更新成功');
            } else {
              await createSpecialZone(data);
