...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'login': '5/minute',
        'payment': '10/minute',
        'catalog_browse_anon': '240/minute',
        'catalog_browse_user': '1200/minute',
    },
...
YLH_SHOP_NAME = EnvironmentConfig.get_env('YLH_SHOP_NAME', '默认店铺')
...
ORDER_PAYMENT_TIMEOUT_MINUTES = int(EnvironmentConfig.get_env('ORDER_PAYMENT_TIMEOUT_MINUTES', '1440'))
